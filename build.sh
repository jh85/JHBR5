...
export MODEL_ONNX=/data/new_jhbr2/JHBR3/shogi_bt4_step12000_dynamic_fp16.onnx
export CC=clang
export CXX=clang++
...
$TENSORRT_PATH/bin/trtexec \
  --onnx="$MODEL_ONNX" \
  --saveEngine=engines/shogi_bt4_step12000_2_trt_o"$BSIZE"_m"$BSIZE"_ws"$PSIZE".engine \
